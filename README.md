...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k9yj48c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k9yj48c.containers.anotherwebservice.com/
...
```
git clone git@github.com:avyas/container-k9yj48c.git
cd container-k9yj48c
```
...
```
docker attach container-k9yj48c
```
